...
async function startServer() {
  try {
    ...
    // curl -X POST -H "Content-Type: application/json" -d '{"message": "Build a team to make an IOS app, and tell me the talent gaps"}' http://localhost:3000/chat/1763847202900
